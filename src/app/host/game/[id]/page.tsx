...
const QUIZZES_CONTENT: Record<string, QuizQuestion[]> = {
  ...
  auditoria: [
    { text: "¿Qué es la auditoría de la configuración de software?", timeLimit: 30, options: [{ text: "Un proceso informal para instalar nuevas versiones de software", isCorrect: false }, { text: "Un proceso formal que verifica si las configuraciones, cambios y elementos de software cumplen con estándares y requisitos de seguridad", isCorrect: true }, { text: "Una herramienta para desarrollar nuevas aplicaciones", isCorrect: false }, { text: "Un método para hacer copias de seguridad del sistema", isCorrect: false }] },
    { text: "¿Cuál es el objetivo principal de la auditoría de configuración de software?", timeLimit: 30, options: [{ text: "Aumentar la velocidad del sistema operativo", isCorrect: false }, { text: "Reducir los costos de licencias de software", isCorrect: false }, { text: "Asegurar la integridad, estabilidad y seguridad del sistema", isCorrect: true }, { text: "Instalar actualizaciones automáticas", isCorrect: false }] },
    { text: "¿Qué verifica la Auditoría de Configuración Funcional (FCA)?", timeLimit: 30, options: [{ text: "Que los elementos del software están ordenados y completos físicamente", isCorrect: false }, { text: "Que el software funciona según lo documentado y cumple con los requisitos funcionales", isCorrect: true }, { text: "Que las licencias de software están vigentes", isCorrect: false }, { text: "Que los servidores tienen suficiente espacio en disco", isCorrect: false }] },
    { text: "¿Qué comprueba la Auditoría de Configuración Física (PCA)?", timeLimit: 30, options: [{ text: "Que el software funciona correctamente bajo carga", isCorrect: false }, { text: "Que todas las modificaciones están autorizadas", isCorrect: false }, { text: "Que los elementos del software están ordenados, completos y correctamente configurados", isCorrect: true }, { text: "Que los usuarios tienen los permisos correctos", isCorrect: false }] },
    { text: "¿Cuál es el primer paso del proceso de auditoría de configuración?", timeLimit: 30, options: [{ text: "Identificación de riesgos", isCorrect: false }, { text: "Elaboración del informe", isCorrect: false }, { text: "Inventario del software instalado", isCorrect: false }, { text: "Planificación: definir alcance, objetivos y recursos", isCorrect: true }] },
    { text: "En la etapa de Identificación de Riesgos, ¿qué tipo de vulnerabilidades se detectan?", timeLimit: 30, options: [{ text: "Fallos de hardware y cortes de energía", isCorrect: false }, { text: "Configuraciones erróneas, contraseñas predeterminadas o software obsoleto", isCorrect: true }, { text: "Problemas de conectividad de red", isCorrect: false }, { text: "Errores en el código fuente de aplicaciones nuevas", isCorrect: false }] },
    { text: "¿Cuál de los siguientes NO es un beneficio de la auditoría de configuración de software?", timeLimit: 30, options: [{ text: "Seguridad mejorada", isCorrect: false }, { text: "Cumplimiento de normas de la industria", isCorrect: false }, { text: "Aumento en el número de empleados del área de TI", isCorrect: true }, { text: "Eficiencia al identificar redundancias y reducir la deuda técnica", isCorrect: false }] },
    { text: "¿Qué debe contener el Informe de Auditoría?", timeLimit: 30, options: [{ text: "Solo las recomendaciones de mejora", isCorrect: false }, { text: "Únicamente el listado de software instalado", isCorrect: false }, { text: "Todos los hallazgos, brechas, riesgos identificados e incumplimientos encontrados", isCorrect: true }, { text: "El presupuesto para nuevas licencias de software", isCorrect: false }] },
    { text: "¿Qué implica la etapa de Cierre y Seguimiento en una auditoría de configuración?", timeLimit: 30, options: [{ text: "Eliminar el software no autorizado sin notificar a nadie", isCorrect: false }, { text: "Presentar el informe, implementar acciones correctivas y verificar la corrección técnica de las soluciones", isCorrect: true }, { text: "Archivar el informe y no realizar ninguna acción adicional", isCorrect: false }, { text: "Contratar nuevos auditores para una segunda revisión", isCorrect: false }] },
    { text: "¿Qué se verifica durante la Revisión de Cambios y Licencias?", timeLimit: 30, options: [{ text: "Que el hardware cumple con los requisitos mínimos del sistema", isCorrect: false }, { text: "Que los procedimientos de gestión de cambios (GCS) se han seguido y que los cambios están documentados, autorizados y son rastreables", isCorrect: true }, { text: "Que los usuarios han completado su capacitación anual", isCorrect: false }, { text: "Que los respaldos de datos se realizan correctamente", isCorrect: false }] },
  ],
};
...
const QUIZ_TITLES: Record<string, string> = {
  ...
  auditoria: "Quiz: Auditoría de la Configuración de Software",
};
